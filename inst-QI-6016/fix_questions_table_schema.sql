...
-- Rename the old questions table
...
INSERT INTO questions (
    ...
    mark, time_seconds, discriminating_factor, status, user_id, task_id,
    difficulty_level_id, cognitive_level_id, learning_outcome_id
)
SELECT 
    question_id, author_creator, date_created, question_text, 
    choice_1, choice_2, choice_3, choice_4, correct_option, 
    mark, time_seconds, discriminating_factor, status, user_id, task_id,
    -- Map old_difficulty_level_id to difficulty_level_id, etc.
    old_difficulty_level_id, old_cognitive_level_id, old_learning_outcome_id
FROM questions_old;
