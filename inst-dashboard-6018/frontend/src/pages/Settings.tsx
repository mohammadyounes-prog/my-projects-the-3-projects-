  ...
  return (
    <div className="dashboard-container nebula-motion-page">
      <div className="dashboard-section" style={{ maxWidth: '700px', marginInline: 'auto' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '1.75rem', fontWeight: '700', color: 'var(--nebula-text)', margin: '0 0 1rem' }}>
          {t('settings.title', 'Settings & Preferences')}
        </h1>
        <div style={{ backgroundColor: 'var(--nebula-bg-input)', border: '1px solid var(--nebula-border)', padding: '1.25rem', borderRadius: 'var(--nebula-radius-md)' }}>
          <p className="settings-stub" style={{ margin: 0, color: 'var(--nebula-text-muted)', fontSize: '0.95rem' }}>
            {t(
