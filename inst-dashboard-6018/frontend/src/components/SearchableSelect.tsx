...
const SearchableSelect = ({ options, value, onChange, placeholder }: any) => {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', marginBottom: '10px' }}>
      ...
      />
      {isOpen && (
        <ul style={{ position: 'absolute', top: '100%', left: 0, width: '100%', maxHeight: '200px', overflowY: 'auto', background: '#fff', border: '1px solid #ccc', zIndex: 10, listStyle: 'none', padding: 0, margin: 0 }}>
